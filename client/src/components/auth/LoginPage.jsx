        ...
        <div className="min-h-screen bg-brand-dark flex items-center justify-center p-4">
            <div className="w-full max-w-md">
                ...
                <div className="bg-brand-card border border-brand-border rounded-2xl p-8 shadow-2xl">
                    <div className="mb-6">
                        <h2 className="text-lg font-bold text-brand-text">Welcome back</h2>
                        <p className="text-brand-muted text-xs mt-1">Sign in to access the ledger system</p>
                    </div>

                    {error && (
                        <div className="mb-5 flex items-start gap-2.5 bg-brand-crimson/10 border border-brand-crimson/30 text-brand-crimson text-xs rounded-lg px-3.5 py-3 transition-premium">
                    ...
                    <form onSubmit={handleSubmit} noValidate className="space-y-5">
                        ...
                        <div>
                            <div className="flex justify-between items-center mb-1.5">
                                ...
                                <button
                                    ...
                                    className="text-[10px] text-brand-accent hover:text-brand-accent/80 transition-colors font-medium"
                                >
                                    Forgot password?
                                </button>
                            </div>
                        ...
                        <label className="flex items-center gap-2.5 cursor-pointer group">
                            <div className="relative">
                                ...
                                />
                                <div className="w-4 h-4 rounded border border-brand-border bg-brand-dark peer-checked:bg-brand-accent peer-checked:border-brand-accent transition-premium flex items-center justify-center">
                                    {form.rememberMe && (
                                        <svg className="w-2.5 h-2.5 text-brand-dark" fill="none" viewBox="0 0 10 10">
                                            <path d="M1.5 5L4 7.5L8.5 2" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                                        </svg>
                                    )}
                                </div>
                            </div>
                            <span className="text-xs text-brand-muted group-hover:text-brand-text transition-colors select-none">
